  ...
  return (
    <section className="resume-section">
      <h2 className="section-heading">
        <span className="heading-text">Technical Projects</span>
      </h2>
      <div className="section-body">
        {projects.map((proj, idx) => (
          <div key={idx} className="timeline-card project-card">
            ...
            <div className="project-tech-bar">
              ...
              <div className="tags-wrapper">
                {proj.tech.map((t, tIdx) => (
                  <span key={tIdx} className="tag tag-accent">{t}</span>
                ))}
              </div>
            </div>
            ...
            <ul className="bullet-list">
              {proj.description.map((desc, dIdx) => (
                <li key={dIdx} className="bullet-point">
                  {desc}
                </li>
              ))}
            </ul>
